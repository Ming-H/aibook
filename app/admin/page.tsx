...
export default function AdminPage() {
  ...
  if (initError) {
    return (
      <div className="page-surface page-surface-soft flex items-center justify-center px-4">
  ...
  return (
    <div className="page-surface page-surface-soft py-8 px-4 sm:px-6 lg:px-8">
