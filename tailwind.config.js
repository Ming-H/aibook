...
module.exports = {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: ['var(--font-sans-display)', 'PingFang SC', 'Hiragino Sans GB', 'Microsoft YaHei', 'sans-serif'],
        mono: ['var(--font-mono-display)', 'ui-monospace', 'SF Mono', 'Cascadia Code', 'monospace'],
      },
      maxWidth: {
        'content': '720px',
        'prose': '768px',
